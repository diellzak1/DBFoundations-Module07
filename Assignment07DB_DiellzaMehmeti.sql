...
-- 2024-11-27,DiellzaMehmeti,Assignment07
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_DiellzaMehmeti')
	 Begin 
	  Alter Database [Assignment07DB_DiellzaMehmeti] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_DiellzaMehmeti;
	 End
	Create Database Assignment07DB_DiellzaMehmeti;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_DiellzaMehmeti;
...
SELECT TOP 1000000
	...
	,InventoryDate 
	,Count
	,PreviousMonthCount = isNull (Lag(Count) Over (Order by ProductName, Month(inventoryDate)),0)
